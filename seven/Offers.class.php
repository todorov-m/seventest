 ...
 *
 */
class seven_Offers extends core_Master  
{
    ...
    var $listFields = 'id,title,dateoffer=Дата, createdBy, createdOn, modifiedBy, modifiedOn';
    /**
     * Права
     */
    var $canRead = 'admin, Headquarter, crm, sales';
     ...
     *  
     */
    var $canEdit = 'admin, Headquarter, crm, sales';
    
    
    /**
     *  
     */
    var $canAdd = 'admin, Headquarter, crm, sales';
    
    
    /**
     *  
     */
    var $canView = 'admin, Headquarter, crm, sales';
    
    
    /**
     *  
     */
    var $canList = 'admin, Headquarter, crm, sales';
	
	var $canSingle = 'admin, Headquarter, crm, sales';
    
    /**
     *  
     */
    var $canDelete = 'admin, Headquarter';
	 ...
	 * 
	 */
	var $canWrite = 'admin, Headquarter, crm';
    
   /**
     * Нов темплейт за показване
     */
   var $singleLayoutFile = 'seven/tpl/SingleLayoutOffers.shtml';    
	...
	{
		$this->FLD('dateoffer', 'date', 'caption=Атрибути на Офертата->Дата,mandatory');
		$this->FLD("title", "varchar(128)", 'caption=Атрибути на Офертата->Заглавие, mandatory');
...
// ...
   ...
   $data->form->setDefault('dateoffer', $today); 
// ...
}
 ...
 static function on_AfterPrepareSingleToolbar($mvc, &$res, $data)
    {
        if (($data->rec->state != 'draft') && ($data->rec->state != 'rejected')) {
            ...
            if (haveRole('jobs')) {
                $data->toolbar->addBtn('Протокол', array('seven_Protocols', 'add', 'originId' => $data->rec->containerId), 'class=btn-clone button');    
            }
         }
    }
